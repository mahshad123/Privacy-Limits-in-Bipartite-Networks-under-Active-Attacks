...
A=zeros(4,5,5);
B=A;
for(k=1:5)  %the number of privacy settings
for(t=1:5)
    tt=0;
    for(m= [1000 2000 5000 10000])
        ...
        P1=0.01;
        P2=0.3;
        [av_c av_I]=Ns(m,r, ITER, alpha, mu,sigma,Pq01,Pq10,P1,P2,k)
        A(k,t,tt)=av_c;
        B(k,t,tt)=av_I;
    end
end
...
legend({'gamma=1','gamma=2','gamma=3','gamma=4','gamma=5'},'Location','southeast')
xlabel('Users') 
ylabel('1-Pe') 
figure
